...
POSITION_FILE = "Flight_Simulator_2024.pkl"
...
if __name__ == "__main__":
    window_title = "Flight Simulator 2024 Checklist"
    checklist_window_title = "MSFS 2024 Pre-Start\nCHECKLIST VERIFICATION:"
    items = [
    ...
    external_program_path = "C:\XboxGames\Microsoft Flight Simulator 2024\Content\FlightSimulator2024.exe"  # Change to your program's path
